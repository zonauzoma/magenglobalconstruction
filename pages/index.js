    ...
    >
      <section className="h-[80vh] flex items-center justify-center bg-[url('https://images.unsplash.com/photo-1503387762-592deb58ef4e')] bg-cover bg-center relative">
        ...
        <div className="relative text-center text-white px-6 max-w-3xl">
          <h1 className="text-4xl md:text-6xl font-bold mb-4">Building with Integrity and Excellence</h1>
          <p className="text-lg mb-6">Your trusted partner in construction across Canada.</p>
          <Link href="/contact" className="bg-blue-600 hover:bg-blue-700 px-6 py-3 rounded text-white font-semibold">
            Get a Free Quote
          </Link>
        </div>
      </section>
